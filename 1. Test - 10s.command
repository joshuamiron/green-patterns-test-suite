...
while true; do
    ...
    # 1. Configuration - Prompt for settings
    echo
    ...
    echo
    (sleep 0.5 && osascript -e 'tell application "Google Chrome" to reload active tab of window 1' && echo "🔄 Refresh triggered!") &

    # 6. Start powermetrics (10 seconds at 100ms resolution)
    echo 
    echo "Recording 10 seconds of data for: $TEST_NAME ($CONDITION, Run $RUN_NUMBER)"
    sudo powermetrics -i 100 -n 100 -f plist -o "$OUTPUT_FILE"
